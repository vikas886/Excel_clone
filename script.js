...
$(document).ready(function () {
  ...
  function changerHeader(ele) {
    ...
    let alignmnet = cellInfo["text-align"];
    $(".align-icon.selected").removeClass("selected");
    $(".icon-align-" + alignmnet).addClass("selected");
...
function getRowCol(ele) {
  ...
  let idArrya = $(ele).attr("id").split("-");
  let rowId = parseInt(idArrya[1]);
  let colId = parseInt(idArrya[3]);
  return [rowId, colId];
}
...
function addSheetEvents() {
  ...
  $(".sheet-tab.selected").contextmenu(function (e) {
    ...
    <input type="text" class=" new-sheet-name" placeholder="sheet name" value=${selectedSheet}>
